# Awesome IPFS [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 444,205 | 🐛 75 | 📅 2026-03-09 with stars
...
* [IPFS Desktop](https://github.com/ipfs-shipyard/ipfs-desktop) ⭐ 6,502 | 🐛 142 | 🌐 JavaScript | 📅 2026-03-02 - IPFS Desktop gives you all the power of IPFS in a convenient desktop app: a complete IPFS node, plus handy OS menubar/taskbar shortcuts and an all-in-one file manager, peer map, and content explorer.
* [Peergos](https://github.com/Peergos/Peergos) ⭐ 2,374 | 🐛 119 | 🌐 Java | 📅 2026-03-07 - End-to-end encrypted, peer-to-peer file storage and sharing.
* [Planet](https://github.com/Planetable/Planet) ⭐ 1,733 | 🐛 78 | 🌐 Swift | 📅 2026-03-09 - Build and host decentralized blogs and websites with IPFS on your Mac
* [archiveweb.page](https://github.com/webrecorder/archiveweb.page) ⭐ 1,424 | 🐛 98 | 🌐 TypeScript | 📅 2026-03-05 - A High-Fidelity Web Archiving Extension for Chrome and Chromium based browsers with support for IPFS.
...
* [Diffuse](https://github.com/icidasset/diffuse) ⭐ 860 | 🐛 15 | 🌐 JavaScript | 📅 2026-03-09 - Play music from your IPFS node, or any other cloud/distributed storage service you use.
* [InterPlanetary Wayback](https://github.com/oduwsdl/ipwb) ⭐ 650 | 🐛 159 | 🌐 Python | 📅 2025-10-10 - Web Archive (WARC) indexing and replay using IPFS.
...
* [hyprspace](https://github.com/hyprspace/hyprspace) ⭐ 212 | 🐛 27 | 🌐 Go | 📅 2026-01-13 - A Lightweight VPN Built on top of IPFS + Libp2p for Truly Distributed Networks.
...
* [IPFS Share](https://github.com/ipfs-shipyard/ipfs-share-files) ⭐ 168 | 🐛 41 | 🌐 TypeScript | 📅 2026-01-26 - Share files directly from the browser using IPFS.
...
* [orbit-db](https://github.com/orbitdb/orbit-db) ⭐ 8,746 | 🐛 20 | 🌐 JavaScript | 📅 2026-02-22 - OrbitDB is a serverless, distributed, peer-to-peer database that uses IPFS as its data storage and IPFS Pubsub to automatically sync databases with peers.
...
* [sourcify](https://github.com/ethereum/sourcify) ⭐ 908 | 🐛 103 | 🌐 TypeScript | 📅 2026-03-09 - Decentralized Solidity contract source code verification service
...
* [mahuta](https://github.com/ConsenSys/Mahuta) ⭐ 245 | 🐛 19 | 🌐 Java | 📅 2024-06-24 - Mahuta is a plug and play service for your micro-service architecture allowing to collect, store and index data on IPFS and offering search functionalities (full text, query).
...
* [IPLD Explorer](https://github.com/ipfs-shipyard/ipld-explorer) ⭐ 132 | 🐛 30 | 🌐 JavaScript | 📅 2026-01-05 - Explore the Merkle Forest from the comfort of your browser.
...
* [Multiverse](https://github.com/multiverse-vcs/go-multiverse) ⭐ 87 | 🐛 7 | 🌐 Go | 📅 2022-03-05 - Multiverse is a decentralized version control system that enables peer-to-peer software development.
...
* [Omnipin](https://github.com/omnipin/omnipin) ⭐ 56 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-09 - The ultimate decentralized website deployment toolkit.
